...
dataset have been pre-loaded as X and y.

In addition to C, logistic regression has a 'penalty' hyperparameter which 
specifies whether to use 'l1' or 'l2' regularization. Your job in this exercise 
is to create a hold-out set, tune the 'C' and 'penalty' hyperparameters of a 
logistic regression classifier using GridSearchCV on the training set, and then 
...
Create training and test sets. Use a test_size of 0.4 and random_state of 42. 
...
This involves first instantiating the GridSearchCV object with the correct 

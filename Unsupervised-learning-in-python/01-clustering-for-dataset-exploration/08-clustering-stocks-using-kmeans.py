...
scaling to unit variance, Normalizer() rescales each sample - here, each 
company's stock price - independently of the other.
...
Using make_pipeline(), create a pipeline called pipeline that chains 
